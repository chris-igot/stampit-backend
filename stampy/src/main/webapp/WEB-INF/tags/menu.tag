...
<nav class="navbar fixed-top navbar-expand-md navbar-dark bg-pblue">
	<div class="container-fluid">
		...
		<button class="navbar-toggler" type="button" data-bs-toggle="collapse"
			data-bs-target="#navbarDark" aria-controls="navbarDark"
		...
		<div class="collapse navbar-collapse" id="navbarDark">
			<ul class="navbar-nav me-auto mb-2 mb-xl-0">
				...
				<li class="nav-item"><a class="nav-link" href="/post/new">New
						Post</a></li>
				<li class="nav-item"><a class="nav-link" href="/home/edit">Edit
						Profile</a></li>
				<li class="nav-item"><a class="nav-link"
					href="/profile/follows">Following</a></li>
