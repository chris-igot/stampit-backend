...
<t:base>
	...
	<div class="row justify-content-center">
		<form:form class="col col-md-6" action="/register" method="POST"
			...
			<div class="card p-2">
				...
				<div class="mb-5">
					<form:label class="form-label mb-0" path="passwordConfirm"
						for="passwordConfirm">Confrim Password: </form:label>
					<form:input type="password" class="form-control"
						path="passwordConfirm" id="passwordConfirm"></form:input>
